  ...
  return (
    <div className="container min-vh-100">
      ...
      <div className='row  mt-5'>
        <div className='col-6'>
          <div className='row justify-content-center mt-1'> <Link to="/RoomE204"><Button >Room E204</Button></Link> </div>
          <div className='row justify-content-center mt-2'> <Link to="/LaboChemie"><Button >Labo Chemie</Button></Link> </div>
          <div className='row justify-content-center mt-2'> <Link to="/SyringeU036"><Button >Syringe U036</Button></Link> </div>
        </div>
        <div className='col-6'>
